...
# ============================================================================
# UNDERSERVED AREAS ANALYSIS - YOUR CODE STARTS HERE
# ============================================================================

print("\n" + "="*60)
print("UNDERSERVED AREAS ANALYSIS")
print("="*60)
...
print("FINAL SUMMARY")
print("="*60)
print(f"Total districts analyzed: {len(gdf_districts)}")
print(f"Districts with university access: {gdf_districts['served_by_university'].sum()}")
print(f"Districts with road access: {gdf_districts['good_road_access'].sum()}")
print(f"Completely underserved districts: {gdf_districts['underserved'].sum()}")
print(f"Top priority district for new university: {top_underserved.iloc[0]['district']}")